...
class Velocity_Addons_Sitemap
{
  ...
  {
    if (get_option('velocity_sitemap_flushed_v5') !== 'yes') {
      $this->add_rewrite_rules();
      flush_rewrite_rules();
      update_option('velocity_sitemap_flushed_v5', 'yes');
    }
  }
  ...
  {
    if (strpos($requested_url, 'sitemap.xml') !== false || strpos($requested_url, 'wp-sitemap.xml') !== false) {
      return false;
    }
    return $redirect_url;
  }
  ...
  public function add_query_vars($vars)
  {
    ...
    $vars[] = 'velocity_sitemap_redirect';
    return $vars;
  }
  ...
  public function render_sitemap()
  {
    ...
    // Redirect wp-sitemap.xml to sitemap.xml
    if (get_query_var('velocity_sitemap_redirect')) {
